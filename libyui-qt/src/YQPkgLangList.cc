...
YQPkgLangSelList::YQPkgLangSelList( QWidget * parent )
    : YQPkgObjList( parent )
{
...
YQPkgLangSelList::~YQPkgLangSelList()
{
    // NOP
}
...
void
YQPkgLangSelList::filterIfVisible()
{
    if ( isVisible() )
	filter();
}
...
void
YQPkgLangSelList::addPkgSelItem( PMSelectionPtr pmSel )
{
    if ( ! pmSel )
    {
    ...
    new YQPkgLangSelListItem( this, pmSel );
}


YQPkgLangSelListItem *
YQPkgLangSelList::selection() const
{
    ...
    return dynamic_cast<YQPkgLangSelListItem *> (item);
}


void
YQPkgLangSelList::applyChanges()
{
...
YQPkgLangSelListItem::YQPkgLangSelListItem( YQPkgLangSelList * pkgSelList, PMSelectionPtr pkgSel )
...
YQPkgLangSelListItem::~YQPkgLangSelListItem()
{
    // NOP
}
...
void
YQPkgLangSelListItem::setStatus( PMSelectable::UI_Status newStatus )
{
 ...
 **/
int
YQPkgLangSelListItem::compare( QListViewItem *	otherListViewItem,
			   int			col,
			   bool			ascending ) const
{
    YQPkgLangSelListItem * other = ( YQPkgLangSelListItem * ) otherListViewItem;
