...
inline void NCstyleInit_xterm( vector<NCstyle::Style> & styleSet )
{
  ...
  attrset->setAttr( NCstyle::ProgbarBgch, 4203617|A_BOLD );
  ...
  attrset->setAttr( NCstyle::ProgbarBgch, 4198497|A_BOLD );
  attrset->setAttr( NCstyle::TextCursor, 7936|A_BLINK );
  // WarnStyle
  ...
  attrset->setAttr( NCstyle::RichTextBIT, 14592|A_BOLD );
  attrset->setAttr( NCstyle::ProgbarCh, 32|A_BOLD );
  attrset->setAttr( NCstyle::ProgbarBgch, 4196449|A_BOLD );
  attrset->setAttr( NCstyle::TextCursor, 7936|A_BLINK );
  // PopupStyle
  ...
  attrset->setAttr( NCstyle::ProgbarBgch, 4207713|A_BOLD );
  attrset->setAttr( NCstyle::TextCursor, 7936|A_BLINK );
}
