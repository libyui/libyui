...
class NCstyle {
  ...
  public:
	...
	: border( b ), activeBorder( ab ), dumb( d ), disabled( dis ),
	  ...
	  switch ( s ) {
	  case NC::WSdisabeled: return disabled;
	  case NC::WSactive:    return nonactive ? normal : active;
	  case NC::WSnormal:
	  case NC::WSdumb:
	    break;
	  }
	  ...
	  switch ( s ) {
	  case NC::WSdisabeled: return disabled;
	  case NC::WSactive:    return activeFrame;
	  case NC::WSnormal:
	  case NC::WSdumb:
	    break;
	  }
	  ...
	  switch ( s ) {
	  case NC::WSdisabeled: return disabledList;
	  case NC::WSactive:    return activeList;
	  case NC::WSnormal:
	  case NC::WSdumb:
	    break;
	  }
