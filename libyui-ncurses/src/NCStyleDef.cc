...
#undef PRT
    ...
    static const char * dumpColor( short c ) {
      ...
      case COLOR_BLACK:   return "bk"; break;
      case COLOR_RED:     return "re"; break;
      case COLOR_GREEN:   return "gr"; break;
      case COLOR_YELLOW:  return "ye"; break;
      case COLOR_BLUE:    return "bl"; break;
      case COLOR_MAGENTA: return "ma"; break;
      case COLOR_CYAN:    return "cy"; break;
      case COLOR_WHITE:   return "wh"; break;
      }
      return "??";
    }
...
void NCStyleDef::saveStyle()
{
  ...
  out << "   Maintainer: Michael Andres <ma@suse.de>" << endl;
  out << endl;
  out << "/-*/" << endl;
