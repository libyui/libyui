...
/**
 * Every EW extension plug-in has to provide a function
 *
 *     YExternalWidgets * createEW( )
 *
 * that creates a EW of that specific type upon the first call and returns that
 * singleton for all subsequent calls.
 **/
